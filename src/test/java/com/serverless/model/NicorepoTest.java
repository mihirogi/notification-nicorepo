...
public class NicorepoTest {
    @Test
    public void 動画が投稿されたのタイプが1件だけ抽出される() throws IOException, NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        Method filterNicorepo = Nicorepo.class.getDeclaredMethod("filterNicorepo", LocalDateTime.class, NiconicoTopic.class);
        filterNicorepo.setAccessible(true);
        List<JSONObject> filterdReports = (List<JSONObject>) filterNicorepo.invoke(nicorepo, localDateTime, NiconicoTopic.UPLOAD);
