...
public class Nicorepo {
    ...
    public DiscordMessage createDiscordMessage(LocalDateTime localDateTime, NiconicoTopic niconicoTopic) {
        ...
        List<JSONObject> embeds = filterdReports.stream()
                .map(report -> {
                    ...
                    author.put("name", report.getJSONObject("senderNiconicoUser")
                            .get("nickname")
                    );
                    author.put("icon_url", report.getJSONObject("senderNiconicoUser")
                            .getJSONObject("icons")
                            .getJSONObject("tags")
                    ...
                    node.put("title", report.getJSONObject("video")
                            .get("title")
                    );

                    node.put("url", NiconicoAPI.WATCH_PAGE.getUrlText() + report.getJSONObject("video")
                            .get("videoWatchPageId")
                    );

                    JSONObject thumbnail = new JSONObject();
                    thumbnail.put("url", report.getJSONObject("video")
                            .getJSONObject("thumbnailUrl")
                            .get("normal")
                    );
